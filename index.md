...
The figure below shows L9 SAE#13344 ("comparison between two things") as it appears in all five attribution graphs — a concrete illustration of what cross-graph feature consistency looks like in practice. The activation pattern and influence score remain stable whether the prompt is a capital-city analogy (top row: Berlin, Rome) or a semantic role analogy (bottom row: Tokyo, Teacher, Bird).

![L9 #13344 across all five analogy prompts — top row: Berlin, Rome; bottom row: Tokyo, Teacher, Bird](assets/images/feature_13344_grid.png)
*Figure 1. L9 SAE#13344 ("comparison between two things") activation across all five attribution graphs. Consistent appearance regardless of analogy domain confirms it encodes relational structure rather than domain-specific content.*
